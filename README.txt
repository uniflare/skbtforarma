...
Added some more informational dialog boxes during a new installation.
...
Fixed a bug when clicking install on a fresh config and waiting would cause an exception.
...
ADDED: New Dialog Boxes to help new users
